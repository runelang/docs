...
slug: 0.1.0/guide/rituals-and-spells
---
...
RuneLang includes higher-order methods on Scrolls (arrays). See the [Methods reference](/0.1.0/reference/methods/) for the full list.
