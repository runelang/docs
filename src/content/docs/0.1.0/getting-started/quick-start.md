...
slug: 0.1.0/getting-started/quick-start
---
...
* [Variables & Types](/0.1.0/guide/variables-and-types/) — the full type system
* [Control Flow](/0.1.0/guide/control-flow/) — quests, odysseys, vigils, and oracles
* [Rituals & Spells](/0.1.0/guide/rituals-and-spells/) — functions, lambdas, and closures
* [Guilds & Realms](/0.1.0/guide/guilds-and-realms/) — classes and enums
